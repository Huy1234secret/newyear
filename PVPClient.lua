...
local minimumEnergyGap = 5
local energyContainerGap = math.max((if isTouchDevice then 20 else 24) + minimumEnergyGap, minimumEnergyGap)
...
sprintStatusLabel.TextSize = isTouchDevice and 16 or 18
